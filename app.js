...
app.use(jwt({ secret: constant.JWT.SECRET}).unless({path: ['/', '/check_database_crud_connection', { url : '/forgot_password', methods : ['PUT']}, { url : '/login', methods : ['POST']}, { url : '/login/logout', methods : ['POST']}, { url : '/notifications', methods : ['POST']}]}));
